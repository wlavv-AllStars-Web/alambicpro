<?php
/* Smarty version 4.3.4, created on 2024-03-27 09:16:49
  from 'module:ps_imagesliderviewstemplateshookslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6603e4012903a7_66334837',
...
function content_6603e4012903a7_66334837 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="5000" data-wrap="true" data-pause="hover" data-touch="true">
    ...
    <ul class="carousel-inner" role="listbox" aria-label="Contentor Carousel">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.1.64:84/modules/ps_imageslider/images/sample-1.jpg" alt="sample-1" loading="lazy" width="1110" height="340">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.1.64:84/modules/ps_imageslider/images/sample-2.jpg" alt="sample-2" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
              ...
              <li class="carousel-item " role="option" aria-hidden="true">
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.1.64:84/modules/ps_imageslider/images/sample-3.jpg" alt="sample-3" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
